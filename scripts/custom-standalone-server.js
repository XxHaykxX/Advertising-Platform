...
// Minimal .env loader (no dependency). Passenger/LSWS does not auto-load .env,
// and Next standalone doesn't either, so we read DATABASE_URL and friends from
// a .env file sitting next to this server. Real environment wins.
(function loadDotEnv() {
  try {
