...
export const UI: Record<string, Dict> = {
  ...
  "about.forBrandsBody": {
    ru: "Просматривайте проекты анонимно, выбирайте подходящие форматы и связывайтесь с создателями напрямую. Ваш продукт — в руках любимых героев зрителей.",
    en: "Browse projects anonymously, pick the right formats and reach creators directly. Your product — in the hands of the characters audiences love.",
    hy: "Դիտեք նախագծերն անանուն, ընտրեք հարմար ձևաչափերը և ուղիղ կապվեք ստեղծագործողների հետ։ Ձեր ապրանքը՝ հանդիսատեսի սիրելի հերոսների ձեռքում։",
  },
  ...
  "about.pillar2Title": { ru: "Анонимность", en: "Anonymity", hy: "Անանունություն" },
  "about.pillar2Body": {
    ru: "Изучайте проекты анонимно и раскрывайтесь только при взаимном интересе.",
    en: "Browse projects anonymously and reveal yourself only on mutual interest.",
    hy: "Ուսումնասիրեք նախագծերն անանուն և բացահայտվեք միայն փոխադարձ հետաքրքրության դեպքում։",
  },
  ...
  "account.brandBrowseBody": {
    ru: "Изучайте проекты анонимно и отправляйте заявки на плейсмент.",
    en: "Browse productions anonymously and submit placement requests.",
    hy: "Ուսումնասիրեք նախագծերը անանուն և ուղարկեք տեղադրման հայտեր։",
  },
