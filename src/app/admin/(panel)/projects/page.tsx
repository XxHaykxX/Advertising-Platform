    ...
    <div>
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-white/55">{projects.length} в каталоге</p>
        </div>
        <Link
          ...
          <table className="w-full min-w-[760px] text-sm">
            <thead>
              <tr className="border-b border-white/10 bg-white/[0.03] text-left text-xs uppercase tracking-wide text-white/45">
                ...
                <th className="px-4 py-3 font-medium">Слоты</th>
                <th className="px-4 py-3 font-medium">Актёры / Сцены</th>
