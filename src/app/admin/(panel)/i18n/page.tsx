  ...
  return (
    <div>
      ...
      <p className="mt-2 max-w-3xl text-muted-foreground">
        {rows.length} ключей интерфейса на трёх языках. Правки сохраняются автоматически, а кнопка
        «Сохранить» досылает то, что ещё не ушло. На сайт тексты попадают только после кнопки
        «Опубликовать» — она пересобирает сайт, это занимает около 5 минут.
      </p>
