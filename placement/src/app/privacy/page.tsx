...
export const metadata: Metadata = {
  ...
  description:
    "Privacy Policy for FP Placement marketplace. Learn how we collect, use, and protect your data.",
};
...
const privacySections: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      "Depending on your jurisdiction, you may have rights including access to your data, correction of inaccuracies, deletion requests, data portability, and withdrawal of consent. To exercise these rights, contact our privacy team at privacy@fpplacement.com. We will respond to verified requests within 30 days. If you believe we have mishandled your data, you may lodge a complaint with your local data protection authority.",
      "For privacy inquiries or concerns, please contact: FP Placement Privacy Team, privacy@fpplacement.com. We update this privacy policy periodically. Significant changes will be communicated via email or prominent notice on the platform. Your continued use of FP Placement constitutes acceptance of the updated policy.",
    ],
  },
];
