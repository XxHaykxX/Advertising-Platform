  ...
  return (
    <>
      ...
      <LegalPage
        ...
        updated="July 2026"
        intro="These Terms of Service govern your access to and use of iGovazd, our website, mobile applications, and services. By accessing or using iGovazd, you agree to be bound by these Terms. If you do not agree, you may not use the platform. Please read carefully."
