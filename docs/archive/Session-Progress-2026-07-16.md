...
⚠️ УСТАРЕЛО: ниже по тексту это описано как «Фаза 2 не на проде» — на самом деле Фаза 2 (`3ca72bc`) задеплоена 2026-07-17, см. `docs/archive/Session-Progress-2026-07-16b.md` и `docs/archive/Session-Progress-2026-07-21.md`.
